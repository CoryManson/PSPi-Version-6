source "cross" "retropie_zero2_armhf" {
  ...
  image_path            = "RetroPie4.8-Zero2-PSPi6-armhf-${var.pspi_version}.img"
  image_size            = "4G"
  image_type            = "dos"
...
source "cross" "retropie_cm4_armhf" {
  ...
  file_unarchive_cmd    = ["gunzip", "$ARCHIVE_PATH"]
  image_build_method    = "resize"
  image_path            = "RetroPie4.8-CM4-PSPi6-armhf-${var.pspi_version}.img"
  image_size            = "4G"
  image_type            = "dos"
...
source "cross" "retropie_cm4_arm64" {
  ...
  file_checksum         = "https://downloads.raspberrypi.com/raspios_lite_arm64/images/raspios_lite_arm64-2024-11-19/2024-11-19-raspios-bookworm-arm64-lite.img.xz.sha256"
