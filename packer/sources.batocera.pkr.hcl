...
source "arm" "batocera36_zero_arm_base" {
...
source "arm" "batocera36_zero2_arm64_base" {
...
source "arm" "batocera38_cm4_arm64_base" {
...
source "arm" "batocera39_cm4_arm64_base" {
  ...
  file_unarchive_cmd    = ["gunzip", "$ARCHIVE_PATH"]
  image_build_method    = "reuse"
  image_path            = "PSPi6.Batocera39.CM4.Base.${var.pspi_version}.img"
  image_size            = "5G"
  image_type            = "dos"
...
source "arm" "batocera38_cm4_arm64" {
